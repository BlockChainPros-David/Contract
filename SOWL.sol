...
contract SOWL is Context, IERC20, Ownable {
    ...
    uint256 private _supply_total       = 1 * 10**11 * 10**_decimals;
    ...
    address payable public _wallet_marketing = payable(0x17e277373De1aD07724B4a31Efe03B3C577e883e);
    ...
    address payable public _wallet_buyback = payable(0x17e277373De1aD07724B4a31Efe03B3C577e883e);
